...
export const getAllCourses = async (req, res, next) => {
    try {
        const query = req.query.query; // Explicitly cast to string
        let courses;
        if (query) {
...
export const addCourse = async (req, res, next) => {
    try {
        const { name, instructor, description, thumbnail, duration, schedule, location, prerequisites, syllabus, } = req.body;
